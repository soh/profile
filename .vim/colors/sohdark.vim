" Vim color file: sohdark.vim
" Maintainer: Randall Hansen
" Last Change: September 2004
...
hi Identifier   cterm=NONE  ctermfg=darkyellow      ctermbg=NONE
hi Ignore       cterm=NONE  ctermfg=red             ctermbg=NONE
...
hi Statement    cterm=NONE  ctermfg=darkgreen       ctermbg=black
hi Type         cterm=bold  ctermfg=yellow           ctermbg=NONE
hi Error        cterm=NONE  ctermfg=white           ctermbg=red
hi Todo         cterm=NONE  ctermfg=blue            ctermbg=yellow
hi Cursor       cterm=NONE  ctermfg=white           ctermbg=black
hi CursorLine   cterm=NONE  term=underline          cterm=underline
