...
"----------
"[p] tag
nnoremap <buffer> ;pc O<p class=""></p><Esc>F<i
vnoremap <buffer> ;pc <Esc>`>a</p><Esc>`<i<p class=""><Esc>l
inoremap <buffer> ;pc <p class=""></p><Esc>2F"a
if has("gui")
 nnoremenu XHtml.Format.Paragraph<Tab>;pp O<p></p><Esc>F<i
 vnoremenu XHtml.Format.Paragraph<Tab>;pp <Esc>`>a</p><Esc>`<i<p><Esc>l
 inoremenu XHtml.Format.Paragraph<Tab>;pp <p></p><Esc>F<i
...
"----------
"[strike] tag
nnoremap <buffer> ;sk O<strike></strike><Esc>F<i
vnoremap <buffer> ;sk <Esc>`>a</strike><Esc>`<i<strike><Esc>l
...
vnoremap <buffer> ;ul <Esc>`>o</ul><Esc>:'<,'>s/^\(\s*\)\(.*\)$/\1    <li>\2<\/li>/<CR>`<O<ul><Esc>:nohl<cr>
...
"----------
"[select] tag
" XXX commented since (a) i never use it, and (b) get it by accident all the time
